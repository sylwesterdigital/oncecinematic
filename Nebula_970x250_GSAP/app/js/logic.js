...
function animation() {
    ...
    mySplitText = new SplitText("#mywords", {type:"words,chars"}), 
    chars = mySplitText.chars; 

	TweenLite.set("#mywords", {color:"#ffe400", perspective:900});

	tl.from('#logo',0.7, {rotation:-10, x:"-=100", opacity:0, transformOrigin:"150px 125px"},"logo+=0.5") 
	
	tl.staggerFrom(chars, 3, {color:"#000000", opacity:0, scale:1, y:80, rotationX:180, transformOrigin:"0% 0% -50",  ease:Back.easeOut}, 0.01, "-=0.7");

	tl.from('#cta',0.7, {opacity:0},"cta+=0")
